...
def search (movie_name):
    '''
    View function to display movie after search results
    '''
...
@main.route('/movpython3.9 manage.py serverie/review/new/<int:id>', methods = ['GET','POST'])
def new_review(id):
    form = ReviewForm()
    movie = get_movie(id)
    ...
    return render_template('movie.html',title = title, review_form=form, movie=movie)
